...
The parts that touch the running game (writing a live setting, telling whether Bindrune is loaded, the panel) are not covered and are checked in game.
