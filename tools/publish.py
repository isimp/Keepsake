...
Usage:
    HEXIUM_TOKEN=... python3 tools/publish.py dist/hexium/Keepsake-0.1.0.zip --store hexium \\
        --team isimp --categories "Quality of Life,Open Source,Valheim 1.0"

    THUNDERSTORE_TOKEN=... python3 tools/publish.py dist/thunderstore/Keepsake-0.1.0.zip --store thunderstore \\
        --team isimp --categories "ai-generated,mods,tweaks,client-side,deep-north-update"

    python3 tools/publish.py dist/hexium/Keepsake-0.1.0.zip --check-only
"""
